...
namespace SharpCompress.Compressors.Deflate
{
    internal class GZipStream : Stream
    {
        ...
        public GZipStream(Stream stream, CompressionMode mode)
            : this(stream, mode, Leayal.PSO2.Updater.CompressionLevel.Default, false, Encoding.UTF8)
        {
        }

        public GZipStream(Stream stream, CompressionMode mode, Leayal.PSO2.Updater.CompressionLevel level)
            : this(stream, mode, level, false, Encoding.UTF8)
        {
        }

        public GZipStream(Stream stream, CompressionMode mode, bool leaveOpen)
            : this(stream, mode, Leayal.PSO2.Updater.CompressionLevel.Default, leaveOpen, Encoding.UTF8)
        {
        }

        public GZipStream(Stream stream, CompressionMode mode, Leayal.PSO2.Updater.CompressionLevel level, bool leaveOpen, Encoding encoding)
        {
